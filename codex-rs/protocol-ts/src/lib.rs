...
pub fn generate_ts(out_dir: &Path, prettier: Option<&Path>) -> Result<()> {
    ...
    // Subagent MCP types
    codex_mcp_server::SubagentRunParam::export_all_to(out_dir)?;
    codex_mcp_server::SubagentsListResponse::export_all_to(out_dir)?;
    codex_mcp_server::SubagentInfo::export_all_to(out_dir)?;
